...
enum CodigoProducto
{
	CODIGO_PRODUCTO_ESPAGUETIS = 0,  // 0
...
void main()
{
	...
	// Uso del switch case con un enum
	
	switch(opcion)
	{
		case OPCION_MENU_ANYADIR:
			printf("Selecionado anyadir (con switch)\n");
			break;
		case OPCION_MENU_MODIFICAR:
			printf("Selecionado modificar (con switch)\n");
			break;
		case OPCION_MENU_ELIMINAR:
			printf("Selecionado eliminar (con switch)\n");
			break;
		default:
			printf("Salimos si no es ninguna de las anteriores\n");
			break;
	}
}
